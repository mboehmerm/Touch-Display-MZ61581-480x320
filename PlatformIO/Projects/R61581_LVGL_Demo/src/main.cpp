...
/*Change to your screen resolution*/
  ...
  static const uint16_t screenWidth  = 480;                 // rotation 1 or 3
  static const uint16_t screenHeight = 320;
#else  
  static const uint16_t screenWidth  = 320;                 // rotation 0 or 2
  static const uint16_t screenHeight = 480;
#endif

#define SIZE_SCREEN_BUFFER screenWidth * screenHeight / 8   // set screen buffer size
...
void setup()
{
    ...
    /*Set the touchscreen calibration data, the actual data for your display can be acquired using
      ...
      uint16_t calData[5] = { 330, 3330, 180, 3500, 5 };  // tft.setRotation(0);
    #elif SCREEN_ROTATION == 1
      uint16_t calData[5] = { 180, 3500, 330, 3330, 6 };
    #elif SCREEN_ROTATION == 2
      uint16_t calData[5] = { 330, 3330, 180, 3500, 3 };
    #elif SCREEN_ROTATION == 3
      uint16_t calData[5] = { 180, 3500, 330, 3330, 0 };
    #endif  
