...
void setup()
{
  ...
  Serial.println(F("R61581 3.5\" SPI Test!")); 
 
  tft.init();            // initialize LCD
  
  tft.setRotation(0);

  uint16_t calData[5] = { 330, 3330, 180, 3500, 5 }; // see R61581_Touch_calibrate.ino
...
void loop(void) {
  ...
  tft.println(F("Tontec MZ61581 on ESP32"));
  tft.println(F(""));
  //tft.setTextSize(1);
  tft.setTextSize(2);
  ...
  tft.setTextColor(TFT_CYAN);
  tft.setTextSize(3);
  tft.println(F("  Test the Touch"));
  tft.println();
  tft.setTextSize(2);
  tft.println(F(" Middle repeats benchmark"));
