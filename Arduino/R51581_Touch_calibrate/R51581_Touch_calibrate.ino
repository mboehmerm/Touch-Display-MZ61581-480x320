...
void setup() {
  ...
  //uint16_t calData[5] = { 330, 3330, 180, 3500, 5 };  // Rotation 0
  //uint16_t calData[5] = { 180, 3500, 330, 3330, 6 };  // Rotation 1
  //uint16_t calData[5] = { 330, 3330, 180, 3500, 3 };  // Rotation 2
  //uint16_t calData[5] = { 180, 3500, 330, 3330, 0 };  // Rotation 3
